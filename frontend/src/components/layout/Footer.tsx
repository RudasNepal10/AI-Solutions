...
const footerLinks = {
  ...
  Services: [
    { href: "/solutions#ai-assistant", label: "AI Virtual Assistant" },
    { href: "/solutions#prototyping", label: "Rapid Prototyping" },
    { href: "/solutions#consulting", label: "AI Consulting" },
    { href: "/solutions#integration", label: "System Integration" },
  ],
  Legal: [
...
export function Footer() {
  return (
    <footer
      className="border-t border-slate-200 dark:border-white/6 bg-slate-50 dark:bg-[#0a0a0f] pt-16 pb-8"
      role="contentinfo"
    >
      <div className="container-custom">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10 pb-12 border-b border-slate-200 dark:border-white/6">
          {/* Brand column */}
          <div className="lg:col-span-2">
            <Link href="/" className="flex items-center gap-2.5 mb-4 group">
              ...
              <span className="font-bold text-lg font-display text-slate-900 dark:text-white">
                AI<span className="text-indigo-600 dark:text-indigo-400">-Solutions</span>
              </span>
            </Link>
            <p className="text-sm text-slate-600 dark:text-slate-400 leading-relaxed max-w-xs mb-6">
              ...
              employee experience. Based in Sunderland, making a worldwide
              impact.
            </p>
            ...
            <div className="flex flex-col gap-2.5">
              ...
              <div className="flex items-center gap-2.5 text-sm text-slate-600 dark:text-slate-400">
                ...
                <a
                  href="mailto:contact@aisolutions.com"
          ...
          <div className="flex items-center gap-2">
            {socials.map((s) => (
              <a
                ...
                href={s.href}
                aria-label={s.label}
                className="w-8 h-8 rounded-lg bg-slate-200 dark:bg-white/6 hover:bg-indigo-500/20 hover:text-indigo-600 dark:hover:text-indigo-400 text-slate-500 dark:text-slate-400 flex items-center justify-center transition-all duration-200"
              >
                {s.icon}
              </a>
            ))}
